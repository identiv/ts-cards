 ...
 */
public class ChangeWriteKey extends DesfireApduCommand {
    static final String NEW_KEY_KEY =
            ChangeWriteKey.class.getSimpleName() + "::NewKey";

    Logger logger = LoggerFactory.getLogger(ChangeWriteKey.class);

    public ChangeWriteKey() {
    }

    public ChangeWriteKey(byte[] newKey) {
